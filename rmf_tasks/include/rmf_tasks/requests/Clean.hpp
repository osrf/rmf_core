...
#ifndef INCLUDE__RMF_TASKS__REQUESTS__CLEAN_HPP
#define INCLUDE__RMF_TASKS__REQUESTS__CLEAN_HPP
...
class Clean : public rmf_tasks::Request
{
public:
...
#endif // INCLUDE__RMF_TASKS__REQUESTS__CLEAN_HPP
