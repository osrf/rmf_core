...
class VehicleTraits::Implementation {
 public:
  struct LimitInfo {
    LimitInfo(VehicleTraits* parent, const double nom_vel,
  ...
  Implementation(VehicleTraits* const parent, const double nom_linear_vel,
                 const double nom_linear_accel, const double nom_rotation_vel,
                 const double nom_rotation_accel, const bool reversible)
...
//==============================================================================
VehicleTraits::Limits::Limits(void* pimpl) : _pimpl(pimpl) {
  // Do nothing
}
...
//==============================================================================
VehicleTraits& VehicleTraits::Limits::set_nominal_acceleration(
    double nom_accel) {
  auto& info = *static_cast<Implementation::LimitInfo*>(_pimpl);
...
//==============================================================================
VehicleTraits::VehicleTraits(const double nom_linear_vel,
                             const double nom_linear_accel,
                             const double nom_rotation_vel,
                             const double nom_rotation_accel,
                             const bool reversible)
    : _pimpl(rmf_utils::make_unique_impl<Implementation>(
          this, nom_linear_vel, nom_linear_accel, nom_rotation_vel,
          nom_rotation_accel, reversible)) {
  // Do nothing
}

//==============================================================================
VehicleTraits::Limits& VehicleTraits::linear() { return _pimpl->_linear; }
...
//==============================================================================
VehicleTraits::Limits& VehicleTraits::rotational() { return _pimpl->_rotation; }
...
//==============================================================================
bool VehicleTraits::is_reversible() const { return _pimpl->_reversible; }
