...
//==============================================================================
rmf_traffic::schedule::Change::UnregisterParticipant convert(
    const rmf_traffic_msgs::msg::ScheduleUnregister& from)
{
  return rmf_traffic::schedule::Change::UnregisterParticipant{
    from.participant_id
  };
}
